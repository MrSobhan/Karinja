  ...
  return (
    <CarouselContext.Provider value={{ onCardClose: handleCardClose, currentIndex }}>
      <div className="relative w-full">
        ...
        <div className="mr-10 justify-end gap-2 hidden md:flex">
          <button
  ...
  return (
    <>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="relative z-10 flex h-[300px] md:h-[400px] w-56 flex-col items-start justify-start overflow-hidden rounded-3xl bg-gray-100 md:w-96 dark:bg-neutral-900">
        <div
